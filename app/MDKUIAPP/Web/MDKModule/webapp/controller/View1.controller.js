sap.ui.define([
	...
	return Controller.extend("crystalcicdtesting02_MDKUIAPP.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("crystalcicdtesting02_MDKUIAPP/mdkindex.html?" + queryString);
